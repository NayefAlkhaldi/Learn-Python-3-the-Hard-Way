# Note: pytest was not running when I had the name of the file as "planisphere_tests".
# It only worked when I renamed it to 'test_NAME' or 'NAME_test'.
